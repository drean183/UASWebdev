...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        mysqli_query($connection, "update berita set beritajudul = '$judulBerita',
                                    beritainti = '$isiBerita',
                                    penulis = '$penulis',
                                    penerbit = '$penerbit',
    ...
    $beritaDestinasi = mysqli_query($connection,"select * from berita, destinasi where beritaID = '$kodeBerita' and berita.destinasiID = destinasi.destinasiID");
    $rowedit2 = mysqli_fetch_array($beritaDestinasi);
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="<?php echo $rowedit['beritaID'] ?>" class="form-control" id="kodeBerita" name="inputkode" placeholder="Kode Berita" maxlength="4">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Judul Berita</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['beritajudul'] ?>" class="form-control" id="namaBerita" name="inputjudul" placeholder="Judul Berita">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Isi Berita</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['beritainti'] ?>" class="form-control" id="alamatBerita" name="inputisi" placeholder="Isi Berita">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Penulis Berita</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['penulis'] ?>" class="form-control" id="penulis" name="inputpenulis" placeholder="Penulis Berita">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['penerbit'] ?>" class="form-control" id="penerbit" name="inputpenerbit" placeholder="Penerbit Berita">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" value="<?php echo $rowedit['tanggalterbit'] ?>" class="form-control" id="tanggalterbit" name="inputtanggal">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="nama destinasi" class="col-sm-2 col-form-label">Kode Destinasi</label>
                        <div class="col-sm-10">
