...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        if(empty($nama))
        {
            mysqli_query($connection, "insert into hotel value ('$kodeHotel', '$namaHotel','$alamatHotel','$keteranganHotel','noimage.png','$kodeArea')");
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg"))
        {
            ...
            mysqli_query($connection, "insert into hotel value ('$kodeHotel', '$namaHotel','$alamatHotel','$keteranganHotel','$nama','$kodeArea')");
            header("location:hotel.php");
        }
    }
?>
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="keteranganHotel" name="inputketerangan" placeholder="Keterangan Hotel">
                        </div>
                    </div>
