...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        mysqli_query($connection, "update area set areanama = '$namaArea', areawilayah = '$areaWilayah',areaketerangan = '$keteranganArea',kabupatenKODE = '$namakabupaten' where areaID = '$kodeArea'");
        header("location:area.php");
    }

    $datakabupaten = mysqli_query($connection,"select * from kabupaten");
    $kode = $_GET["ubaharea"];
    $editArea = mysqli_query($connection, "select * from area where areaID = '$kode'");
    $rowedit = mysqli_fetch_array($editArea);
    $areaJoinKabupaten = mysqli_query($connection,"select * from kabupaten, area where areaID = '$kode' and kabupaten.kabupatenKODE = area.kabupatenKODE");
    $rowedit2 = mysqli_fetch_array($areaJoinKabupaten);
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="<?php echo $rowedit['areaID'] ?>" class="form-control" id="kodeArea" name="inputKodeArea" placeholder="Kode Area" maxlength="4">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Nama Area</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['areanama'] ?>" class="form-control" id="namaArea" name="inputNamaArea" placeholder="Nama Area">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Area Wilayah</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['areawilayah'] ?>" class="form-control" id="wilayahArea" name="inputWilayah" placeholder="Area Wilayah">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Keterangan Area</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['areaketerangan'] ?>" class="form-control" id="keteranganArea" name="inputKeteranganArea" placeholder="Keterangan Area">
                        </div>
                    </div>
