...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        mysqli_query($connection, "update provinsi set provinsinama = '$namaProvinsi', provinsiketerangan = '$keteranganProvinsi' where provinsiID = '$kodeProvinsi'");
        header("location:provinsi.php");
        
    }

    $kode = $_GET["ubahprovinsi"];
    $editProvinsi = mysqli_query($connection, "select * from provinsi where provinsiID = '$kode'");
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="<?php echo $rowedit['provinsiID'] ?>" class="form-control" id="kodeProvinsi" name="inputKodeProvinsi" placeholder="Kode Provinsi" maxlength="4">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Nama Provinsi</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['provinsinama'] ?>" class="form-control" id="namaProvinsi" name="inputNamaProvinsi" placeholder="Nama Provinsi">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Keterangan Provinsi</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['provinsiketerangan'] ?>" class="form-control" id="keteranganProvinsi" name="inputKeterangan" placeholder="Keterangan Provinsi">
                        </div>
                    </div>
