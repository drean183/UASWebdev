...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        if(empty($nama))
        {
            mysqli_query($connection, "insert into kuliner value ('$kodeKuliner', '$namaKuliner','$keteranganKuliner','noimage.png','$kodeProvinsi')");
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg"))
        {
            ...
            mysqli_query($connection, "insert into kuliner value ('$kodeKuliner', '$namaKuliner','$keteranganKuliner','$nama','$kodeProvinsi')");
            header("location:kuliner.php");
        }
    }
?>
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="kodeKuliner" name="inputkode" placeholder="Kode Kuliner" maxlength="4">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Nama Kuliner</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="namaKuliner" name="inputnama" placeholder="Nama Kuliner">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Keterangan Kuliner</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="keteranganKuliner" name="inputketerangan" placeholder="Keterangan Kuliner">
                        </div>
                    </div>
