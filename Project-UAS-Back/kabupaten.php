...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        if(empty($nama))
        {
            mysqli_query($connection, "insert into kabupaten value ('$kodekabupaten', '$namakabupaten','$alamatkabupaten','$keterangankabupaten','noimage','$keteranganicon')");
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg"))
        {
            ...
            mysqli_query($connection, "insert into kabupaten value ('$kodekabupaten', '$namakabupaten','$alamatkabupaten','$keterangankabupaten','$nama','$keteranganicon')");
            header("location:kabupaten.php");
        }
    }
?>
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="alamatKabupaten" name="inputalamat" placeholder="Alamat Kabupaten">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Keterangan Kabupaten</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="keteranganKabupaten" name="inputketerangan" placeholder="Keterangan Kabupaten">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="keteranganicon" name="inputketeranganicon" placeholder="Keterangan Icon Kabupaten">
                        </div>
                    </div>
