...
<?php
        ...
        if(isset($_POST['simpan'])){
            ...
            mysqli_query($connection, "update kategori2 set kategorinama = '$kategorinama',kategoriketerangan = '$kategoriket',kategorireferensi = '$kategoriref' where kategoriID = '$kategorikode'");
            header("location:kategori.php");
        }
    
    $kode = $_GET["ubahkategori"];
    $editkategori = mysqli_query($connection, "select * from kategori2 where kategoriID = '$kode'");
            ...
            <div class="col-sm-10">
                ...
                <form method="POST">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="<?php echo $rowedit['kategoriID']?>" class="form-control" id="kodekategori" placeholder="Kode" name="inputkode" maxlength="4">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namakategori" class="col-sm-2 col-form-label">Nama Kategori</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['kategorinama']?>" class="form-control" id="namakategori" placeholder="Nama Kategori" name="inputnama">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="keterangan" class="col-sm-2 col-form-label">Keterangan</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['kategoriketerangan']?>" class="form-control" id="keterangan" placeholder="Keterangan" name="inputketerangan">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="referensi" class="col-sm-2 col-form-label">Referensi</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['kategorireferensi']?>" class="form-control" id="referensi" placeholder="Referensi" name="inputref">
                        </div>
                    </div>
