...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        $keteranganHotel = $_POST['inputketerangan'];
        ...
        if(empty($nama))
        {
            mysqli_query($connection,"update hotel set hotelnama = '$namaHotel',
                                        hotelalamat = '$alamatHotel', 
                                        hotelketerangan = '$keteranganHotel',
                                        areaID = '$kodeArea' 
        ...
        {
            move_uploaded_file($file_tmp, 'img/imgdata/hotel'.$nama);
    ...
    $hotelArea = mysqli_query($connection,"select * from hotel, area where hotelID = '$kodeHotel' and hotel.areaID = area.areaID");
    $rowedit2 = mysqli_fetch_array($hotelArea);
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4">Input Tabel Hotel</h1>
                    </div>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly value="<?php echo $rowedit['hotelID'] ?>" class="form-control" id="kodeHotel" name="inputkode" placeholder="Kode Hotel" maxlength="4">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Nama Hotel</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['hotelnama'] ?>" class="form-control" id="namaHotel" name="inputnama" placeholder="Nama Hotel">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Alamat Hotel</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['hotelalamat'] ?>" class="form-control" id="alamatHotel" name="inputalamat" placeholder="Alamat Hotel">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="namafoto" class="col-sm-2 col-form-label">Keterangan Hotel</label>
                        <div class="col-sm-10">
                            <input type="text" value="<?php echo $rowedit['hotelketerangan'] ?>" class="form-control" id="keteranganHotel" name="inputketerangan" placeholder="Keterangan Hotel">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <img src="img/imgdata/hotel/<?php echo $rowedit['hotelfoto']?>" style="width : 200px; height: 200px;">
                            <p class="help-block">Field ini digunakan untuk unggah file</p>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="nama kabupaten" class="col-sm-2 col-form-label">Kode Area</label>
                        <div class="col-sm-10">
                            <select name="kodeArea" id="namaHotel" class="form-control">
                                ...
                                <?php 
                                    ...
                                    { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    if(is_file("img/imgdata/hotel/".$row['hotelfoto']))
                                                    { ?>
                                                        <img src="img/imgdata/hotel/<?php echo $row['hotelfoto']?>" width="80">
                                            <?php   } else
